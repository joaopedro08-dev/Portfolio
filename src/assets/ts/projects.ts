...
export const projects: Project[] = [
    ...
    },
    {
        ...
        {
            title: "ProductStack",
                description: "Sistema de gerenciamento de produtos com interface moderna e API feita em PHP.",
                type: ["Web", "Front-end", "Back-end"],
                techs: ["php", "composer", "phpmyadmin", "api-rest", "html-css-javascript", "googlefonts"],
                github: "https://github.com/joaopedro08-dev/ProductStack",
                title: "ProductStack",
        },
        {
                title: "Projeto Integrador Transportes",
                description: "Projeto integrador realizado na faculdade Unifio no 1º semestre de 2026.",
            type: ["Web"],
            techs: ["openstreetmap", "google-fonts", "html-css", "material-symbols"],
            github: "https://github.com/joaopedro08-dev/Projeto-Integrador-Transportes",
        },
        {
                title: "StackForge",
            ...
            type: ["Back-end"],
            techs: ["graphql", "boilerplate", "jwt", "authentication", "rest-api", "scaffold", "expressjs"],
